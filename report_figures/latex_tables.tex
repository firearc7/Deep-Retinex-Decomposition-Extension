...
Bilateral Filter & Illumination & \checkmark & -- & -- \\
Adaptive Gamma & Illumination & -- & \checkmark & \checkmark\checkmark \\
...
% 1. Unsharp masking with moderate parameters (alpha=1.5, sigma=1.0)
...
% Unsharp Masking:
% S'_out = S_out + alpha * (S_out - G_sigma * S_out), alpha=1.5
