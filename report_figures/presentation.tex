...
\begin{tikzpicture}[scale=0.85, transform shape,
    ...
    \node[box, fill=accentorange!30] (decom) at (3.5,0) {DecomNet\\(250K)};
    \node[box, fill=accentorange!30] (relight) at (7,0) {RelightNet\\(305K)};
...
\vspace{-0.3cm}
\begin{itemize}\setlength{\itemsep}{0pt}
    \item $\alpha=1.0$, $\sigma=1.0$ for edge enhancement
\end{itemize}
...
\begin{itemize}\setlength{\itemsep}{0pt}
    \item CLAHE + Gamma synergy without saturation artifacts
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item +23.9\% entropy, +144.8\% contrast, +104.4\% colorfulness
    \end{itemize}
